---
name: at-doc-reviewer-opus
description: at-doc-writer が書いたドキュメントを Opus が精読してレビューする。Phase 3R で使用。読者視点・正確性・構造を見る。at-doc-reviewer-codex と独立票。
model: opus
