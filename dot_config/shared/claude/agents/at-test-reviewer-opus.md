---
name: at-test-reviewer-opus
description: at-tester が作成したテストを Opus が精読してレビューする。Phase 3R で使用。網羅性・モック妥当性・フレイキー耐性・テストとしての自己検証性を見る。at-test-reviewer-codex とは独立票。
model: opus
